...
import p2pdops.dopsender.frags.ImagesFolderFragment

class ImagesSelectorPagerAdapter(
    ...
    override fun getItem(position: Int): Fragment =
        ImagesFolderFragment.newInstance(position, folderPath = foldersList[position].path)
