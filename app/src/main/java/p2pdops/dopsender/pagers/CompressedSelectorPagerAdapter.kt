...
import p2pdops.dopsender.frags.CompressedFolderFragment


class CompressedSelectorPagerAdapter(
    ...
    override fun getItem(position: Int): Fragment =
        CompressedFolderFragment.newInstance(position, folderPath = foldersList[position].path)
